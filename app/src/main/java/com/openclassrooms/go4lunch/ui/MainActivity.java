    ...
    ActivityResultLauncher<Intent> autoCompleteResultLauncher = registerForActivityResult(
            ...
            result -> {
                ...
                if (resultCode == Activity.RESULT_OK) {
                    ...
                    Log.i(TAG, "MainActivity.autoCompleteResultLauncher Place: "/* + place.getName() + ", "*/ + place.getId()/* + ", " + place.getAddress()*/);
//                    String address = place.getAddress();
    ...
    public void onSearchCalled() {
        ...
        List<Place.Field> fields = Arrays.asList(Place.Field.ID, Place.Field.TYPES); //, Place.Field.NAME, Place.Field.ADDRESS, Place.Field.LAT_LNG);
